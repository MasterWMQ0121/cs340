...
#define Expression_EXTRAS                                                      \
  ...
  virtual op_type get_type(CgenEnvironment *) = 0;                             \
  virtual void    set_type(CgenEnvironment *, op_type) = 0;                    \
  op_type op;                                                          \
  Symbol type;                                                                 \
...
#define Expression_SHARED_EXTRAS                                               \
  ...
  void dump_with_types(std::ostream &, int);                                   \
  op_type get_type(CgenEnvironment *env) override {return op;}                 \
  void set_type(CgenEnvironment *env, op_type type) override {op = type;}   

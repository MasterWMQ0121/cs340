...
public:
  ...
  op_type *type_find_in_scopes(Symbol name) {
  ...
  void type_add_binding(Symbol name, op_type *op) { type_table.insert(name, op); }
  void type_open_scope() { type_table.enterscope(); }
  void type_close_scope() { type_table.exitscope(); }
